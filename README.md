...
| Метрика | Значение |
| --- | --- |
| Всего автоматизированных тестов | **37** (34 функциональных + 3 производительности) |
| Пройдено автотестов | 37 / 37 |
...
| Найдено багов ручным тестированием | 3 (BUG-005 Minor, BUG-006 Major, BUG-007 Major) |
